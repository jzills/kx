...
| `kx diagnostic [<index>]` | Diagnose an indexed Deployment, StatefulSet, DaemonSet, Job, or Pod, or triage the whole namespace when no index is given; alias: kx diag. |
